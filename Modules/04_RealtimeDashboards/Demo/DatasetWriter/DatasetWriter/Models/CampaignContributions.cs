...
namespace DatasetWriter.Models {
  ...
  public class ContributionsDataFactory {
    ...
    public static Contribution GetNextContribution() {
      contributionCount += 1;
    ...
    public static ContributionSet GetContributionList() {
      ...
      List<Contribution> list = new List<Contribution>(ContributionCount);
      for (int i = 1; i <= ContributionCount; i++) {
        list.Add(GetNextContribution());
      }

      Console.Write(".");
      return new ContributionSet { rows = list.ToArray() };
    }

    #region "Static fields with arrays of sample data values"
    ...
    private static LocationData[] ContributionLocations2 = new LocationData[]{
      ...
      new LocationData{ City="Macdill AFB, Port Tampa", State="FL", Zipcode=33621},
      new LocationData{ City="Macdill AFB, Port Tampa", State="FL", Zipcode=33621 },
      new LocationData{ City="Macdill AFB, Port Tampa", State="FL", Zipcode=33621 },
    };
    ...
    #region "Methods to help generate simulated contribution data"
